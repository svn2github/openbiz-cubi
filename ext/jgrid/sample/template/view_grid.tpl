...
$includedScripts.="
<script type='text/javascript' src='".RESOURCE_URL."/jgrid/js/i18n/grid.locale-en.js'></script>
<script type='text/javascript' src='".RESOURCE_URL."/jgrid/js/jquery.jqGrid.min.js'></script>
<script type='text/javascript' src='".RESOURCE_URL."/jgrid/js/Openbiz.GridForm.js'></script>
";
...
<link rel=\"stylesheet\" href=\"$js_url/jquery-ui/ui-redmond/jquery-ui-1.8.16.custom.css\" type=\"text/css\" />
<link rel=\"stylesheet\" href=\"".RESOURCE_URL."/jgrid/css/ui.jqgrid.css\" type=\"text/css\" />
";
