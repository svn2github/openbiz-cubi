...
<div style="width:600px;height:600px;border:none;">
	...
	<div style="padding-left:60px;">
		<h1 style="font-size:24px; padding:0px; margin:0px;color:#333333;">财务帐户消费通知</h1>
		<p style="font-size:14px; padding:0px; margin:0px;padding-top:30px;line-height:22px;color:#333333;padding-right:60px;">
		亲爱的 {$display_name} ，<br/>您在客户服务中心刚刚发生了消费，该笔交易详细信息如下：<br/>
		<br/>
		<table>
			<tr>
			...
			<tr>
				<td>消费金额</td>
				<td style="color:#ff0000;">{$credit_display}</td>
			</tr>
			<tr>
				<td>消费时间</td>
				<td>{$create_time}</td>
