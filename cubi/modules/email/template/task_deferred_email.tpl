...
<div style="width:600px;height:600px;border:none;">
	...
	<div style="padding-left:60px;">
		<h1 style="font-size:24px; padding:0px; margin:0px;color:#333333;">You have a task has been auto deferred</h1>
		<p style="font-size:14px; padding:0px; margin:0px;padding-top:30px;line-height:22px;color:#333333;">
	The task <strong style="color:#02a5ea;">{$title}</strong> <br/>
	should be start on <strong style="color:#02a5ea;">{$start_time}</strong><br/>
	Task description: <br/>
	{$description}
	<br/>
	Because of the task is not start as plan, system has automaticly set its status to Deferred.
	<br/><br/>
	...
	<tr><td width="600" height="152" style="width:600px;height:152px;background-image: url({$refer_url}/images/email_background_footer.jpg);"><img width="600" height="152" alt="Openbiz Email Footer" src="{$refer_url}/images/email_background_footer.jpg" border="0" style="width:600px;height:152px;border:none;"/></td></tr>
	</table>
	</div>
</div>	
</body>