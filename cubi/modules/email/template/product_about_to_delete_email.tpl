...
<div style="width:600px;height:600px;border:none;">
	...
	<div style="padding-left:60px;">
		<h1 style="font-size:24px; padding:0px; margin:0px;color:#333333;">您的产品已经超期并即将被删除</h1>
		...
		该产品的已经超期未续费且即将在 <span style="color:#02a5ea;">{$product_delete_in}日</span> 后（{$product_delete_time}）被系统删除。<br/>
		如果您需要继续使用该产品，为避免数据丢失请您尽快续费。<br/>
		<br/>
		{$product_info}<br/>
		<br/>
