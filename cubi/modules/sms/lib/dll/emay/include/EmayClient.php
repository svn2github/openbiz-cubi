...
require_once(dirname(dirname(__FILE__)).'/nusoaplib/nusoap.php');
...
class EmayClient{
	 ...
	 * 
	 */
	function EmayClient($url,$serialNumber,$password,$sessionKey='',$proxyhost = false,$proxyport = false,$proxyusername = false, $proxypassword = false, $timeout = 0, $response_timeout = 30)
	{
		$this->url = $url;
