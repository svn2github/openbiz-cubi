...
<span style="display: block;float: left;"><a class="menu_index_link" href="{$app_index}/sms/dashboard">{t}Index{/t}</a></span> 
<a href="{$app_index}/sms/dashboard"><img id="system_dashboard" class="btn_dashboard"  src="{$image_url}/spacer.gif" border="0" /></a></p>
</div>
