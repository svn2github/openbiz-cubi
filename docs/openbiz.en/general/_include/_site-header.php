<div id="site-header-wrapper">
	<div id="site-header">
		<div class="top-header">
			<?php //require_once(SITE_ROOT_PATH.'/general/_include/_site-login-widget.php'); ?>			
			<div class="logo">
				<a href="<?php echo SITE_URL?>"></a>
			</div>
			<div class="menu">
				<ul>
					<!--<li><a class="homepage"			href="/">首页</a></li>
					<li><a class="enterprise"		href="/enterprise">面向企业应用</a></li>
