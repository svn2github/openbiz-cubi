<?php 
class ProjectGanttForm extends EasyForm
{
	public $m_ViewMode=0;
	public $m_print = 0;
	...
	public function renderGantt()
	{
		...
		$projectDo = BizSystem::getObject("collab.project.do.ProjectDO");
		...
		{						
			...
			$projectRec['project_start_time'] = date('Y,m,d',strtotime($projectRec['start_time']));				
