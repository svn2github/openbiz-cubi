...
<div style="padding-left:25px;padding-right:40px;">
	...
	<div style="padding-left:10px;">
		...
		<div class="underline" style="height:50px;">			
			{foreach name=phone item=item key=itemName from=$dataPanel}
				{if $itemName != "fld_Id" and $item.elementset eq "Contact"}			
					{if $smarty.foreach.phone.index is odd}
					<table  id="{$itemName}_container" class="input_row" style="float:left;padding-right:20px;">
					{else}
					<table  id="{$itemName}_container" class="input_row" style="float:left;padding-right:20px;">
					{/if}								
					<tr>
		...
		<div class="underline" style="height:150px;">			
			{foreach name=phone item=item key=itemName from=$dataPanel}
