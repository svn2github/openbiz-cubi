...
class ProjectForm extends ChangeLogForm
{
	...
	public function getProjectSpent($project_id)
	{
		...
		$total_spend=0;
		$taskList = BizSystem::getObject("project.task.do.TaskSystemDO")->directfetch("[project_id]='$project_id'");
	...
	{
		return BizSystem::getObject("project.task.do.TaskSystemDO")->deleteRecords("[project_id]='".(int)$project_id."'");		
	}
}
?>
