...
class ProjectImportForm extends ProjectForm
{
	public function ImportTasks()
	{
		...
		if($rec['use_template']==1){
			...
			$templateId = BizSystem::getObject("project.project.widget.ProjectTemplateListForm")->m_RecordId;
	...
	{
		$taskTemplates = BizSystem::getObject("project.project.do.ProjectTaskTemplateDO")->directFetch("[project_id]='$templateId'");
