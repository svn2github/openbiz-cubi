...
class ProjectStatDO extends BizDataObj
{
	public function fetch()
	{
		...
		$lovService->m_SelectFrom="project.project.lov.ProjectLOV(ProjectCondition)";
		$cond_list = $lovService->getDictionary("project.project.lov.ProjectLOV(ProjectCondition)");
		$resultSet = array();
