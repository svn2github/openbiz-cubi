...
class WorklogStatListForm extends EasyFormGrouping
{
	public function fetchDataGroup()
	{
		...
		$parentForm = BizSystem::getObject("project.statistics.form.WorklogStatReportForm");			
		$day = sprintf('%02d',$parentForm->m_CategoryId+1);
		
		$parentForm = BizSystem::getObject("project.statistics.form.UserWorkhourReportForm");	
